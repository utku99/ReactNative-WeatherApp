          ...
          <SafeAreaView className="flex flex-1">
                  ...
                  <View className="absolute w-full bg-gray-300 top-16 rounded-3xl ">
                    {
                      locations.map((loc, index) => {
                        let showBorder = index + 1 != locations.length //son konum olup olmadığı
            ...
            <View className="mx-4 justify-around flex-1 mb-2">
              ...
              <View className="flex-row justify-between mx-4">
                <View className="items-center space-y-1">
                  <View>
                    <Text className="text-white font-bold text-base">Rüzgar Hızı</Text>
                  </View>
                ...
                <View className="space-y-1 items-center">
                  <View>
                    <Text className="text-white font-bold text-base">Nem</Text>
                  </View>
                  <View className="flex-row space-x-2">
                ...
                <View className="space-y-1 items-center">
                  <View>
                    <Text className="text-white font-bold text-base">Gün Doğumu</Text>
                  </View>
                  <View className="flex-row space-x-2">
            ...
            <View className="mb-2 space-y-3">
              <View className="flex-row items-center mx-5 space-x-2">
                ...
                <Text className="text-white text-base">10 Günlük Tahmin</Text>
              </View>
              <ScrollView
                horizontal
              ...
              >
                {
                  weather?.forecast?.forecastday?.map((item, index) => {
                    const date = new Date(item.date) //date nesnesine dönüştürür
                    let dayName = date.toLocaleDateString('tr-TR', { weekday: 'short' })
                    let date2 = dayName.split(" ")[0]
                    ...
                    return (
                      ...
                      >
                        <Image
                          ...
                          className="w-11 h-11" />
                        <Text className="text-white">{date2}</Text>
